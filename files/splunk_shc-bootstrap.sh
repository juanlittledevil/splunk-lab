...
# bootstrap command
su - splunk -c "export SPLUNK_HOME=${splunk_home}; ${splunk_executable} bootstrap shcluster-captain -servers_list https://192.168.3.63:8189,https://192.168.3.63:8289,https://192.168.3.63:8389 -auth 'admin:changeme'"

# do a rolling restart to get the cluster complete.
su - splunk -c "export SPLUNK_HOME=${splunk_home}; ${splunk_executable} rolling-restart shcluster-members"

# helper script to start all instances.
# =====================================
mkdir /home/vagrant/bin
cp ${base}/files/startAll.sh /home/vagrant/bin
sed -i "s/REPLACE_THIS/$splunk_instances/g" /home/vagrant/bin/startAll.sh
chmod 755 /home/vagrant/bin/startAll.sh
